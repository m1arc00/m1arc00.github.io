...
if (navigator.userAgent.indexOf('AppleWebKit/41') == -1 && !window.opera) {
  if(!window.TimesPeople) {
    document.write('<script src="http://graphics8.nytimes.com/js/app/timespeople/preloader.js" type="text/javascript" charset="utf-8"><\/script>');
  }
  document.write('<script src="http://graphics8.nytimes.com/js/app/timespeople/loader.js" type="text/javascript" charset="utf-8"><\/script>');
}
